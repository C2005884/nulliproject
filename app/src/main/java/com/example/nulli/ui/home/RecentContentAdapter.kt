...
class RecentContentAdapter : RecyclerView.Adapter<RecentContentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemRecentContentBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    inner class ViewHolder(val binding: ItemRecentContentBinding) : RecyclerView.ViewHolder(binding.root) {
